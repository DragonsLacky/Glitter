...
if(MSVC)
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_IMPLIB_DEBUG "C:/Program Files (x86)/Glitter/lib/${importLibraryName}"
      IMPORTED_LOCATION_DEBUG "C:/Program Files (x86)/Glitter/bin/${sharedLibraryName}"
    )
    ...
    set_property(TARGET assimp::assimp APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
    set_target_properties(assimp::assimp PROPERTIES
      IMPORTED_LOCATION_DEBUG "C:/Program Files (x86)/Glitter/lib/${staticLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
  ...
  if(ASSIMP_BUILD_SHARED_LIBS)
    ...
    set_target_properties(assimp::assimp PROPERTIES
      ...
      IMPORTED_LOCATION_DEBUG "C:/Program Files (x86)/Glitter/lib/${sharedLibraryName}"
    )
    list(APPEND _IMPORT_CHECK_TARGETS assimp::assimp )
