...
StartScreen::StartScreen()
{
	MouseEnabled = true;
	Level1 = new Level_1();
	StartButton = Cube(glm::vec3(-0.5f, 0.8f, 0.0f), glm::vec3(1.0f, 0.2f, 0.0f), "Resources/Textures/", "StartButton.png");
	LevelsButton = Cube(glm::vec3(-0.5f, 0.5f, 0.0f), glm::vec3(1.0f, 0.2f, 0.0f), "Resources/Textures/", "LevelSelsectButton.png");
	ExitButton = Cube(glm::vec3(-0.5f, 0.2f, 0.0f), glm::vec3(1.0f, 0.2f, 0.0f), "Resources/Textures/", "ExitButton.png");
...
Level_1::Level_1()
{
	cubes.push_back(Cube(glm::vec3(0.0f, 0.0f, -2.0f), glm::vec3(3.0f, 0.5f, 3.0f), "Resources/Textures/", "grass.jpg"));
	cubes.push_back(Cube(glm::vec3(0.0f, -0.5f, -2.0f), glm::vec3(3.0f, 1.0f, 3.0f), "Resources/Textures/", "dirt.jpg"));

	cubes.push_back(Cube(glm::vec3(3.0f, 0.7f, -2.0f), glm::vec3(3.0f, 0.5f, 3.0f), "Resources/Textures/", "grass.jpg"));
	cubes.push_back(Cube(glm::vec3(3.0f, 0.2f, -2.0f), glm::vec3(3.0f, 1.0f, 3.0f), "Resources/Textures/", "dirt.jpg"));

	cubes.push_back(Cube(glm::vec3(3.5f, 4.0f, -2.0f), glm::vec3(3.0f, 0.5f, 3.0f), "Resources/Textures/", "grass.jpg"));
	cubes.push_back(Cube(glm::vec3(3.5f, 3.5f, -2.0f), glm::vec3(3.0f, 1.0f, 3.0f), "Resources/Textures/", "dirt.jpg"));

	skybox = CubeMap("Resources/Textures/skybox/");

	DestCubes.push_back(Cube(glm::vec3(2.0f, 1.0f, -2.0f), glm::vec3(glm::vec3(1.0f, 1.0f, 3.0f)), "Resources/Textures/", "container2.png"));
}
